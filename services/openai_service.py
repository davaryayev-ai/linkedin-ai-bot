...
async def analyze_linkedin_post(post_text: str, stats: str) -> dict:
    ...
    system_prompt = (
        ...
        "ВАЖНЫЙ КОНТЕКСТ: В узких нишах (например, IT, автоматизация, n8n) набрать 1000-3000 просмотров на LinkedIn — это ОТЛИЧНЫЙ результат. Не называй такую статистику 'низкой'. Наоборот, ищи причины, почему пост так хорошо зашел в узкой нише.\n"
