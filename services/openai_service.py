...
async def analyze_linkedin_post(post_text: str, stats: str) -> dict:
    ...
    system_prompt = (
        ...
        "ВАЖНЫЙ КОНТЕКСТ ДЛЯ ОЦЕНКИ СТАТИСТИКИ (особенно для IT/n8n ниши):\n"
        "- Менее 500 просмотров: Это низкий результат. Укажи на ошибки и причины провала.\n"
        "- Около 500-1000 просмотров: Средний/Нормальный результат.\n"
        "- Более 1000 просмотров: Это ОТЛИЧНЫЙ результат. Хвали пост и выявляй причины его успеха.\n"
